...
if( $_SERVER['REQUEST_METHOD'] == 'POST' ) {
    if( $_POST['template-contactform-name'] != '' AND $_POST['template-contactform-email'] != '' AND $_POST['template-contactform-message'] != '' ) {
        ...
        $subject = isset($subject) ? $subject : 'New Message From Wireless Security Alarms Limited - Contact Us Page';

        $botcheck = $_POST['template-contactform-botcheck'];

        $toemail = 'sales@wirelesssecurityalarms.co.uk'; // Your Email Address
        $toname = 'Wireless Security Alarms Limited - Sales'; // Your Name
        $ccemail = 'jimmcenaney@hotmail.com';
        $ccname = 'James McEnaney';
        ...
        if( $botcheck == '' ) {
            ...
            $mail->SMTPAuth   = true; 
            $mail->Port       = 26;    
            $mail->Username   = "wsa2016"; 
            $mail->Password   = "Geranium035"; 
